...
public class AccountV3 {
    ...
    private AccountTypeV3 accountType;

    private AccountV3(int daysOverdrawn, AccountTypeV3 accountType) {
        this.daysOverdrawn = daysOverdrawn;
        this.accountType = accountType;
    }

    public static AccountV3 of(int daysOverdrawn, AccountTypeV3 accountType) {
        return new AccountV3(daysOverdrawn, accountType);
    }
