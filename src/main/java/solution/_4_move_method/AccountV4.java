...
public class AccountV4 {
    ...
    private AccountTypeV4 accountType;

    private AccountV4(int daysOverdrawn, AccountTypeV4 accountType) {
        this.daysOverdrawn = daysOverdrawn;
        this.accountType = accountType;
    }

    public static AccountV4 of(int daysOverdrawn, AccountTypeV4 accountType) {
        return new AccountV4(daysOverdrawn, accountType);
    }
