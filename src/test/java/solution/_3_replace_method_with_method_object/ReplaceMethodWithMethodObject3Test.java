...
class ReplaceMethodWithMethodObject3Test {
	...
	@Test
	void gamma1() {
		ReplaceMethodWithMethodObject3 replaceMethodWithMethodObject3 = new ReplaceMethodWithMethodObject3(50);
		assertThat(replaceMethodWithMethodObject3.gamma(100, 3, 500)).isEqualTo(349860);
	}
	...
	void gamma2() {
		ReplaceMethodWithMethodObject3 replaceMethodWithMethodObject3 = new ReplaceMethodWithMethodObject3(50);
		assertThat(replaceMethodWithMethodObject3.gamma(100, 4, 500)).isEqualTo(349800);
	}
}